...
async def main():
    ...
    working_dir = os.path.join(base_dir, "test_working_dir")
    ...
    if file_list:
        ...
        try:
            ...
            # Insert the file
            await lightrag.ainsert(file_text, file_paths=test_file["file_path"])
            ...
            result = await lightrag.aquery(query, param=QueryParam(mode="naive"))
            print("Query result:")
            print(result)
